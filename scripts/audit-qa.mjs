...
const PAGES = [
  ...
  { path: '/about/ramniwas-verma/', file: 'about/ramniwas-verma/index.html', indexable: true },
  { path: '/process/', file: 'process/index.html', indexable: true },
  { path: '/blog/', file: 'blog/index.html', indexable: true },
  { path: '/blog/meet-ramniwas-verma/', file: 'blog/meet-ramniwas-verma/index.html', indexable: true },
